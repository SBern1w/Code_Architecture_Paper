...
mpirun -n 48 python ./code/tracking_multiCPU.py --n_inputs $n_inputs --arct $arct --pc_iloss_mu $pc_iloss_mu --pc_iloss_sigma $pc_iloss_sigma --folder_path $folder_path
