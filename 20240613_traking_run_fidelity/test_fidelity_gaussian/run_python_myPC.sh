...
cd 20240613_traking_run_fidelity/test_fidelity_gaussian
...
mpirun -n 12 python ./code/tracking_multiCPU.py --n_inputs $n_inputs --arct $arct --pc_iloss_mu $pc_iloss_mu --pc_iloss_sigma $pc_iloss_sigma --folder_path $folder_path
